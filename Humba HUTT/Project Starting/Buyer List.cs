...
{
    public partial class Buyer_List : Form
    {
        ...
        void BindGridGrave()
        {
            ...
            string query = "select * from BUYER_LIST";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from BUYER_LIST where mobile=@mobile";
            ...
            if (a > 0)
            {
                MessageBox.Show(" Buyer Data Deleted Successfully !!");
                BindGridGrave();
                ResetAuto();
            }
            else
